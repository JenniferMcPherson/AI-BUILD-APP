    ...
    <header className="flex h-16 items-center justify-between border-b border-border bg-surface px-6">
      ...
      <div className="relative" ref={menuRef}>
        ...
        >
          ...
          <ManageBillingButton className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-sm text-foreground hover:bg-surface-hover disabled:opacity-50">
            {(pending) => (
              <>
